...
create table products_bazhenov_is.products
(
...
create table products_bazhenov_is.carts
(
    id         integer generated always as identity primary key,
    promo_code varchar(255)
);

create table products_bazhenov_is.carts_products
(
    id         integer generated always as identity primary key,
...
create table products_bazhenov_is.clients
(
    id       integer generated always as identity primary key,
    name     varchar(255) not null,
    email    varchar(255),
