...
const CartProductCard = ({cartProduct}) => {
  ...
  const reduceProductCountByOne = () => {
    // первый способ не уйти в минус по количеству
    // if (cartProduct.productCountInCart === 1) {
    //   userService.deleteProductInUserCart(user.id, cartProduct.product.id, dispatch);
    //   return ;
    // }
    ...
    <Card
      ...
      actions={[
        ...
        <Button
          ...
          disabled={cartProduct.productCountInCart === 1}
        />,
      ]}
